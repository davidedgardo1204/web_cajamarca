          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Stroke>
                  <se:SvgParameter name="stroke">#754826</se:SvgParameter>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>circle</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#423939</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
                  <se:SvgParameter name="stroke">#754e16</se:SvgParameter>
                  <se:SvgParameter name="stroke-width">1</se:SvgParameter>
                </se:Stroke>
              </se:Mark>
              <se:Size>7</se:Size>
...
syntax error, unexpected ELSE - Expression was: ELSE-->
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#431717</se:SvgParameter>
            </se:Fill>
